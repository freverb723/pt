        ...
        <?php require 'header.php'; ?>
          ...
          $period = new DatePeriod(
            new DateTime('first day of last month'),
              ...
              new DateTime('last day of last month +1 second')
         );
         $deadline = new DateTime('+7days');
         $today = new DateTime('today');
         $last_m = new DateTime('last month');
          ...
          ?>
					<div class="row">
						<div class="col-12">
                            ...
                            <div class="card-header pb-0"><h3 class="text-center"><span class="text-white"><i class="fas fa-angle-double-left pr-3"></i></span>
                            <?php echo $last_m->format('F Y');?>
                            <a href="./timerecord.php"><i class="fas fa-angle-double-right pl-3"></i></a></h3>
