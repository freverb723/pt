        ...
        <?php require 'header.php'; ?>
          ...
          $period = new DatePeriod(
            new DateTime('first day of this month'),
              ...
              new DateTime('last day of this month +1 second')
         );
          ...
          ?>
					<div class="row">
						<div class="col-12">
                            ...
                            <div class="card-header pb-0"><h3 class="text-center"><a href="./timerecord_lm.php"><i class="fas fa-angle-double-left pr-3"></i></a>
                            <?php echo $today->format('F Y');?>
                            <a href="./timerecord_nm.php"><i class="fas fa-angle-double-right pl-3"></i></a></h3>
